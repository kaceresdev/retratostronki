...
import { StreetPhotographyImagesPageComponent } from "./pages/street-photography/images-page/images-page.component";
...
export const routes: Routes = [
  ...
  { path: "street-photography/:id", component: StreetPhotographyImagesPageComponent, pathMatch: "full" },
